...
<img src="assets/widgets/profile-dashboard.svg" alt="Saket745 GitHub profile intelligence dashboard — repositories, stars, forks, streaks, lifetime contributions, top languages, tech stack and recent activity" width="100%"/>

<sub>Detected, recalculated and rendered entirely by <a href="https://github.com/Saket745/Saket745/blob/main/.github/workflows/profile-intelligence.yml">GitHub Actions</a> — no server, no hosting, no separate app. See <a href="docs/PROFILE_INTELLIGENCE.md">how it works</a>.</sub>
...
> The dashboard above is recalculated from live GitHub data on a ~10 minute poll, plus an instant path for repositories that opt in — see [how it works](docs/PROFILE_INTELLIGENCE.md).
